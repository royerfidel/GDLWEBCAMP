...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-07-2020 a las 00:38:59
...
(1, 'luis123', 'Angel Luis', '$2y$12$Aa7daI3YAXCLxM6e.sxfq.7dFwF7/QfSZEI7HP4UPszBRzqYzGrmy', '2020-07-16 11:48:08', 0),
(7, 'luisa123', 'Luisa', '$2y$12$o2Kyj0sK3hQ5Hl0RLl/3a.mJEuqIiZY0HJnSD8nzoNtqHEu4jdZ7W', '0000-00-00 00:00:00', 1),
(22, 'arian', 'arian', '$2y$12$Tj3QKnR.T4GBMwvhIHsKiOvWw6s6oWwMf5IJ/O3UI16llW5pXc2nK', '0000-00-00 00:00:00', 0);
...
CREATE TABLE `boletos` (
  ...
  `numero_dias` tinyint(3) NOT NULL,
...
INSERT INTO `boletos` (`id`, `tipo`, `numero_dias`, `descripcion`, `precio`) VALUES
(1, 'un_dia', 1, 'Pase por un solo día', '30.00'),
(2, 'completo', 0, 'Todos los días', '50.00'),
(3, '2dias', 2, 'Pase por dos días', '45.00');
...
(2, 'Conferencia', 'fa-comments', '2020-07-16 11:39:31'),
(3, 'Talleres', 'fa-code', '0000-00-00 00:00:00'),
(12, 'Faenas', 'fa-apple', '2020-07-23 11:49:20');
...
(25, 'Creando Plantillas para WordPress Pro', '2016-12-11', '17:00:00', 3, 4, 'taller_15', '2020-07-16 11:36:23'),
...
(53, 'lop', '2020-07-01', '10:15:00', 12, 17, '', '0000-00-00 00:00:00'),
(54, 'Quedate en casa', '2020-07-24', '10:30:00', 12, 17, '', '0000-00-00 00:00:00'),
(55, 'A vacilar', '2020-07-24', '10:30:00', 12, 17, '', '0000-00-00 00:00:00'),
(56, 'Somos Todos Perú', '2020-07-06', '12:21:32', 12, 17, '', '0000-00-00 00:00:00'),
(57, 'Somos Todos Perú', '2020-07-06', '11:05:04', 12, 17, '', '2020-07-06 12:05:04');
...
(2, 'Chari', 'Herrera ', 'Cantante y periodista.', 'invitado2.jpg', '2020-07-09 16:58:24'),
...
(17, 'Arian 7', 'Herrera 7', '7', 'bg-newsletter.jpg', '0000-00-00 00:00:00');
...
(115, 'Alex Fidel', 'Vasquez Gutierrez', 'royerfidel123456@gmail.com', '2020-07-16 18:26:32', '{\"un_dia\":\"\",\"pase_completo\":\"1\",\"pase_2dias\":\"\",\"camisas\":1,\"etiquetas\":3}', '{\"eventos\":[\"10\",\"21\",\"22\",\"24\",\"25\",\"26\"]}', 1, '65.3', 0),
(122, 'Luis', 'Auvel', 'auvel_04072001@outlook.com', '2020-07-16 19:26:08', '{\"un_dia\":\"\",\"pase_completo\":\"1\",\"pase_2dias\":\"\",\"camisas\":12,\"etiquetas\":12}', '{\"eventos\":[\"5\",\"8\",\"18\",\"29\"]}', 1, '185.60000000000002', 0),
(123, 'Jordan', 'Guere', 'auvel_04072001@outlook.com', '2020-07-16 19:28:20', '{\"un_dia\":\"\",\"pase_completo\":\"1\",\"pase_2dias\":\"\",\"camisas\":123,\"etiquetas\":14}', '{\"eventos\":[\"8\",\"14\",\"29\"]}', 1, '1221.9', 1),
(132, 'Gabriel', 'Ñaupa', 'auvel_04072001@outlook.com', '2020-07-23 21:28:36', '{\"un_dia\":\"\",\"pase_completo\":\"1\",\"pase_2dias\":\"\",\"camisas\":14,\"etiquetas\":12}', '{\"eventos\":[\"3\",\"4\",\"8\",\"18\",\"28\",\"53\"]}', 1, '204.20000000000002', 0),
(133, 'Gabriel', 'Ñaupa', 'auvel_04072001@outlook.com', '2020-07-23 21:28:52', '{\"un_dia\":\"\",\"pase_completo\":\"1\",\"pase_2dias\":\"\",\"camisas\":14,\"etiquetas\":12}', '{\"eventos\":[\"3\",\"4\",\"8\",\"18\",\"28\",\"53\"]}', 1, '204.20000000000002', 0),
(134, 'Gabriel', 'Ñaupa', 'auvel_04072001@outlook.com', '2020-07-23 21:30:23', '{\"un_dia\":\"\",\"pase_completo\":\"1\",\"pase_2dias\":\"\",\"camisas\":14,\"etiquetas\":12}', '{\"eventos\":[\"3\",\"4\",\"8\",\"18\",\"28\",\"53\"]}', 1, '204.20000000000002', 0),
(135, 'Gabriel', 'Ñaupa', 'auvel_04072001@outlook.com', '2020-07-23 21:33:27', '{\"un_dia\":\"\",\"pase_completo\":\"1\",\"pase_2dias\":\"\",\"camisas\":14,\"etiquetas\":12}', '{\"eventos\":[\"3\",\"4\",\"8\",\"18\",\"28\",\"53\"]}', 1, '204.20000000000002', 0),
(136, 'Gabriel', 'Ñaupa', 'auvel_04072001@outlook.com', '2020-07-23 21:40:47', '{\"un_dia\":\"\",\"pase_completo\":\"1\",\"pase_2dias\":\"\",\"camisas\":14,\"etiquetas\":12}', '{\"eventos\":[\"3\",\"4\",\"8\",\"18\",\"28\",\"53\"]}', 1, '204.20000000000002', 0);
...
--
ALTER TABLE `categoria_evento`
  MODIFY `id_categoria` tinyint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `eventos`
--
ALTER TABLE `eventos`
  MODIFY `evento_id` tinyint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `invitados`
  MODIFY `invitado_id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `registrados`
  MODIFY `id_registrado` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
