  ...
  <section class="seccion  contenedor">
    ...
    <?php
      ...
      try {
        ...
        $sql_calendario="select evento_id, nombre_evento, fecha_evento, hora_evento, cat_evento, icono, nombre_invitado, apellido_invitado from eventos";
        $sql_calendario.=" inner join categoria_evento on eventos.id_cat_evento = categoria_evento.id_categoria ";
        $sql_calendario.=" inner join invitados on eventos.id_inv = invitados.invitado_id";
        $sql_calendario.=" order by evento_id";
        $resultado=$conn->query($sql_calendario);
